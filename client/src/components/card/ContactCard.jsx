...
const ContactCard = ({ position, name, linkedin }) => {
  return (
    <div className="w-9/12 border-2 border-slate-500 mt-8 h-40 rounded-lg shadow-lg hover:relative hover:top-0.5 flex flex-col gap-2 justify-center items-center">
