...
const Footer = () => {
  return (
    <footer className="bg-fifth p-4 pt-16 pb-12 space-y-8 sm:px-8 md:pb-8 md:pr-4 lg:px-10 text-lg text-black xl:pb-12 xl:pt-24 xl:pl-20 2xl:pl-32 2xl:pt-32">
      {/* Logo */}
